  ...
  return (
    <div className="space-y">
      <div>
        ...
        <p className="small muted">Use this dashboard for weekly working hours, cumulative TIL, weekly TIL, outstanding expenses and daily hours against the 7.5h standard.</p>
      </div>
      <div className="card">
