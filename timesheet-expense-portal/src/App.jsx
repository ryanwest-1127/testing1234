    ...
    <div className="bg-gradient min-h-screen">
      <div className="container space-y">
        ...
        <div className="grid grid-4">
          <Metric label="Annual Leave Remaining" value="28 / 28 days" sub="Annual allowance" icon={<CalendarDays />} />
          <Metric label="Time in Lieu Remaining" value={`${totals.tilBalance.toFixed(2)} hrs`} sub="TIL balance" icon={<FileCheck2 />} />
          <Metric label="Total Expense" value={money(totals.totalExpense)} sub="Current form" icon={<ReceiptText />} />
          <Metric
