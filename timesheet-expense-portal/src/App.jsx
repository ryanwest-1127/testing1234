  ...
  return (
    <div className="space-y">
      <div>
        ...
        <p className="small muted">Use this dashboard for weekly working hours, cumulative TIL, weekly TIL, outstanding expenses, weekly expenses and category charts.</p>
      </div>
      <div className="card">
